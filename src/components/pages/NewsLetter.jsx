...
function NewsLetter() {
    return (
        <div>
                ...
                <div className="flex flex-col gap-[15px]">
                    <div>
                        <p className=" text-[#18191B]">
                            <strong className="text-[14px]">NewsLetter</strong>
                        </p>
                    </div>
            ...
            <div className="px-[20px] flex items-center flex-wrap text-[14px] py-[10px] bg-[#f1f2f3] text-[#666970] border-[#e4e5e7] border-b border-solid">
                <p className="flex items-center gap-[5px]">
                    <span>
                        Smart filter classifies Newsletters and Promotional
                        emails automatically to this folder.
                    </span>
                    <span className="flex items-center gap-[5px] whitespace-nowrap">
                        <span className="text-[#2558BB]">Disable</span>
                        <span>Automatic</span>
                        <span className="text-[#2558BB]">NewsLetter</span>
                        <span>classification</span>
                    </span>
                </p>
                <p className=" ml-auto text-[#2558BB]">Do not ask again</p>
            </div>
